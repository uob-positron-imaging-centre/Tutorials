...
the `pept` package, showing the clustered cutpoints along with the centroids.
...
save_centres_1_filepath = 'tracked_data/bms_a26_1pass.csv'
...
ylim =              [0, 500]
zlim =              [0, separation]
subplot_titles =    ['Clustered cutpoints', 'Centroids']
...
grapher.add_trace(clustered_cutpoints_1.all_points_trace_colorbar(), col = 1)
grapher.add_trace(centres_1.all_points_trace_colorbar(), col = 2)
